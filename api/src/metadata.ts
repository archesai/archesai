...
export default async () => {
  const t = {
    ...
    ["./common/aggregated-field.dto"]: await import(
      "./common/aggregated-field.dto"
    ),
    ["./threads/dto/thread-query.dto"]: await import(
      "./threads/dto/thread-query.dto"
    ),
    ...
    ["./chatbots/entities/chatbot.entity"]: await import(
      "./chatbots/entities/chatbot.entity"
    ),
    ["./content/entities/content.entity"]: await import(
      "./content/entities/content.entity"
    ),
    ["./threads/entities/thread.entity"]: await import(
      "./threads/entities/thread.entity"
    ),
    ["./vector-records/entities/vector-record.entity"]: await import(
      "./vector-records/entities/vector-record.entity"
    ),
    ["./messages/entities/message.entity"]: await import(
    ...
    "@nestjs/swagger": {
      models: [
        ...
        [
          ...
          {
            OrganizationEntity: {
              billingEmail: { required: true, type: () => String },
        ...
        [
          import("./common/paginated.dto"),
          {
            ...
            _PaginatedDto: {
              metadata: {
                required: true,
                type: () => t["./common/paginated.dto"].Metadata,
              },
            },
            PaginatedDto: {
        ...
        [
          import("./api-tokens/dto/api-token-query.dto"),
          {
            ApiTokenQueryDto: { name: { required: false, type: () => String } },
          },
        ],
        [
          ...
          import("./api-tokens/entities/api-token.entity"),
          {
            ...
            ApiTokenEntity: {
              chatbots: {
                required: true,
                type: () => [
                  t["./api-tokens/entities/api-token.entity"].ChatbotsFieldItem,
                ],
              },
              domains: { required: true, type: () => String, default: "*" },
        ...
        [
          ...
          {
            CreateApiTokenDto: {
              chatbotIds: { required: false, type: () => [String] },
            },
          },
        ],
        [
        ...
        [
          import("./chatbots/dto/chatbot-query.dto"),
          {
            ChatbotQueryDto: { name: { required: false, type: () => String } },
          },
        ],
        ...
        [
          import("./email-change/dto/request-email-change.dto"),
          {
        ...
        [
          import("./email-verification/dto/confirm-password-reset.dto"),
          {
          ...
          import("./members/dto/member-query.dto"),
          {
            MemberQueryDto: {
              sortBy: {
                ...
                type: () => Object,
                default: "username",
                enum: t["./members/dto/member-query.dto"].SortByField.USERNAME,
              },
            },
          },
        ],
        ...
        [
          import("./common/aggregated-field.dto"),
          {
            GroupCount: {
            ...
            GranularSum: {
              from: { required: true, type: () => Date },
              sum: { required: true, type: () => Number },
              to: { required: true, type: () => Date },
            },
          },
        ],
        [
          import("./threads/entities/thread.entity"),
          {
            ThreadEntity: {
              credits: { required: true, type: () => Number },
              name: { required: true, type: () => String },
              numMessages: { required: true, type: () => Number },
              orgname: { required: true, type: () => String },
            },
          },
        ],
        [
          import("./threads/dto/create-thread.dto"),
          { CreateThreadDto: { id: { required: false, type: () => String } } },
        ],
        [
          import("./threads/dto/thread-aggregates.dto"),
          {
            ThreadAggregates: {
              credits: {
                required: true,
                type: () => [t["./common/aggregated-field.dto"].GranularSum],
              },
              threadsCreated: {
                required: true,
                type: () => [t["./common/aggregated-field.dto"].GranularCount],
              },
            },
          },
        ],
        [
          import("./threads/dto/thread-query.dto"),
          {
            ThreadQueryDto: {
              aggregateGranularity: {
                required: false,
                enum: t["./common/aggregated-field.dto"].Granularity,
              },
              aggregates: {
                required: false,
                type: () => Boolean,
              ...
              sortBy: {
                ...
                type: () => Object,
                default: "createdAt",
                enum: t["./threads/dto/thread-query.dto"].SortByField.CREATED,
              },
            },
          },
        ],
        [
          import("./vector-records/dto/vector-record-query.dto"),
          { VectorRecordQueryDto: {} },
        ],
        [
          import("./vector-records/entities/vector-record.entity"),
          {
            VectorRecordEntity: {
              text: { required: true, type: () => String },
            },
        ...
        [
          import("./messages/dto/message-query.dto"),
          {
            MessageQueryDto: {
              sortBy: {
                required: false,
                type: () => Object,
                default: "createdAt",
                enum: t["./messages/dto/message-query.dto"].SortByField,
              },
            },
          },
        ],
        [
          import("./threads/entities/citation.entity"),
          {
            CitationEntity: {
              similarity: { required: true, type: () => Number },
            },
          },
        ],
        [
          import("./messages/entities/message.entity"),
          {
            MessageEntity: {
              answer: { required: true, type: () => String },
              answerLength: { required: true, type: () => Number },
              citations: { required: true },
              contextLength: { required: true, type: () => Number },
              credits: { required: true, type: () => Number },
              question: { required: true, type: () => String },
              similarityCutoff: { required: true, type: () => Number },
        ...
        [
          import("./messages/dto/create-message.dto"),
          {
            CreateMessageDto: {
              answerLength: {
                required: true,
              ...
              temperature: { required: true, type: () => Number, default: 0.7 },
              topK: { required: true, type: () => Number, default: 5 },
            },
          },
        ],
        [
          import("./password-reset/dto/confirm-password-reset.dto"),
          {
        ...
        [
          import("./password-reset/dto/request-password-reset.dto"),
          {
        ...
        [
          import("./members/dto/member-aggregates.dto"),
          {
            MemberAggregates: {
              _info: { required: false, type: () => Object },
            },
          },
        ],
        [
      ...
      controllers: [
        [
          import("./billing/billing.controller"),
          {
            BillingController: {
              ...
              listPaymentMethods: { type: [Object] },
              removePaymentMethod: {},
        ...
        [
          import("./users/user.controller"),
          {
            UserController: {
              deactivate: {},
              findOne: { type: t["./users/entities/user.entity"].UserEntity },
              update: { type: t["./users/entities/user.entity"].UserEntity },
            },
          },
        ],
        [
          ...
          {
            AuthController: {
              login: { type: t["./auth/dto/token.dto"].TokenDto },
              refreshToken: { type: t["./auth/dto/token.dto"].TokenDto },
              register: { type: t["./auth/dto/token.dto"].TokenDto },
        ...
        [
          import("./chatbots/chatbots.controller"),
          {
            ChatbotsController: {
              create: {
                type: t["./chatbots/entities/chatbot.entity"].ChatbotEntity,
              },
              findAll: {},
              findOne: {
                type: t["./chatbots/entities/chatbot.entity"].ChatbotEntity,
        ...
        [
          import("./jobs/jobs.controller"),
          {
            JobsController: {
              findAll: {},
              findOne: { type: t["./jobs/entities/job.entity"].JobEntity },
              remove: {},
            },
          },
        ],
        ...
        [
          import("./email-change/email-change.controller"),
          {
        ...
        [
          import("./email-verification/email-verification.controller"),
          {
        ...
        [
          import("./threads/threads.controller"),
          {
            ThreadsController: {
              create: {
                type: t["./threads/entities/thread.entity"].ThreadEntity,
              },
              findAll: {},
              findOne: {
                type: t["./threads/entities/thread.entity"].ThreadEntity,
        ...
        [
          import("./vector-records/vector-record.controller"),
          {
            VectorRecordController: {
              findAll: {},
              findOne: {
                type: t["./vector-records/entities/vector-record.entity"]
                  .VectorRecordEntity,
              },
            },
          },
        ...
        [
          import("./messages/messages.controller"),
          {
            MessagesController: {
              create: {
                type: t["./messages/entities/message.entity"].MessageEntity,
              },
              findAll: {},
            },
          },
        ...
        [
          import("./password-reset/password-reset.controller"),
          {
