...
-- CreateIndex
CREATE UNIQUE INDEX "_ContentToTool_AB_unique" ON "_ContentToTool"("A", "B");

-- CreateIndex
CREATE INDEX "_ContentToTool_B_index" ON "_ContentToTool"("B");
...
-- AddForeignKey
ALTER TABLE "Job" ADD CONSTRAINT "Job_toolId_fkey" FOREIGN KEY ("toolId") REFERENCES "Tool"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Job" ADD CONSTRAINT "Job_contentId_fkey" FOREIGN KEY ("contentId") REFERENCES "Content"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_ContentToTool" ADD CONSTRAINT "_ContentToTool_A_fkey" FOREIGN KEY ("A") REFERENCES "Content"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ContentToTool" ADD CONSTRAINT "_ContentToTool_B_fkey" FOREIGN KEY ("B") REFERENCES "Tool"("id") ON DELETE CASCADE ON UPDATE CASCADE;
