...
// UpdateExecutor defines the executor interface for the UpdateExecutor operation.
type UpdateExecutor = executor.Executor[UpdateExecutorInput, UpdateExecutorOutput]
...
func (h *UpdateExecutorImpl) Execute(ctx context.Context, input *UpdateExecutorInput) (*UpdateExecutorOutput, error) {
	...
	// Publish event
	event := schemas.NewExecutorUpdatedEvent(updated.ID)
