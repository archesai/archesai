...
var (
	// ErrInvitationNotFound is returned when a Invitation entity is not found.
...
func NewInvitation(
	...
	invitation.addEvent(NewInvitationCreatedEvent(id))
...
func NewInvitationCreatedEvent(id uuid.UUID) *InvitationCreatedEvent {
	return &InvitationCreatedEvent{
		BaseEvent:    events.NewBaseEvent("invitation", EventInvitationCreated),
		InvitationID: id,
	}
}
...
func NewInvitationUpdatedEvent(id uuid.UUID) *InvitationUpdatedEvent {
	return &InvitationUpdatedEvent{
		BaseEvent:    events.NewBaseEvent("invitation", EventInvitationUpdated),
		InvitationID: id,
	}
}
...
func NewInvitationDeletedEvent(id uuid.UUID) *InvitationDeletedEvent {
	return &InvitationDeletedEvent{
		BaseEvent:    events.NewBaseEvent("invitation", EventInvitationDeleted),
		InvitationID: id,
	}
}
