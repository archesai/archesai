...
// UpdateOrganization defines the executor interface for the UpdateOrganization operation.
type UpdateOrganization = executor.Executor[UpdateOrganizationInput, UpdateOrganizationOutput]
...
func (h *UpdateOrganizationImpl) Execute(ctx context.Context, input *UpdateOrganizationInput) (*UpdateOrganizationOutput, error) {
	...
	// Publish event
	event := schemas.NewOrganizationUpdatedEvent(updated.ID)
