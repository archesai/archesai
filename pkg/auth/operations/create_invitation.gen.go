...
// CreateInvitation defines the executor interface for the CreateInvitation operation.
type CreateInvitation = executor.Executor[CreateInvitationInput, CreateInvitationOutput]
...
func (h *CreateInvitationImpl) Execute(ctx context.Context, input *CreateInvitationInput) (*CreateInvitationOutput, error) {
	...
	// Publish event
	event := schemas.NewInvitationCreatedEvent(created.ID)
