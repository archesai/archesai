...
func NewConfirmPasswordResetHandler(confirmPasswordReset handlers.ConfirmPasswordReset) *ConfirmPasswordResetHandler {
...
func (h *ConfirmPasswordResetHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	input := &handlers.ConfirmPasswordResetInput{}
