...
func NewRequestEmailVerificationHandler(requestEmailVerification handlers.RequestEmailVerification) *RequestEmailVerificationHandler {
...
func (h *RequestEmailVerificationHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	input := &handlers.RequestEmailVerificationInput{}
