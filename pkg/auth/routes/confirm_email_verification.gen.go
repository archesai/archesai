...
func NewConfirmEmailVerificationHandler(confirmEmailVerification handlers.ConfirmEmailVerification) *ConfirmEmailVerificationHandler {
...
func (h *ConfirmEmailVerificationHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	input := &handlers.ConfirmEmailVerificationInput{}
