...
func NewRequestPasswordResetHandler(requestPasswordReset handlers.RequestPasswordReset) *RequestPasswordResetHandler {
...
func (h *RequestPasswordResetHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	input := &handlers.RequestPasswordResetInput{}
