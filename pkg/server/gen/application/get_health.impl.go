// Package application provides business logic implementations for the server module.
package application
...
func (h *GetHealthImpl) Execute(_ context.Context, _ *GetHealthInput) (*GetHealthOutput, error) {
