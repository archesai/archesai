...
// UpdateTool defines the executor interface for the UpdateTool operation.
type UpdateTool = executor.Executor[UpdateToolInput, UpdateToolOutput]
...
func (h *UpdateToolImpl) Execute(ctx context.Context, input *UpdateToolInput) (*UpdateToolOutput, error) {
	...
	// Publish event
	event := schemas.NewToolUpdatedEvent(updated.ID)
