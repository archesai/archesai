...
// CreateRun defines the executor interface for the CreateRun operation.
type CreateRun = executor.Executor[CreateRunInput, CreateRunOutput]
...
func (h *CreateRunImpl) Execute(ctx context.Context, input *CreateRunInput) (*CreateRunOutput, error) {
	...
	// Publish event
	event := schemas.NewRunCreatedEvent(created.ID)
