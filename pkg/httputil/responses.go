...
// NewUnprocessableEntityResponse creates a new 422 Unprocessable Entity response
func NewUnprocessableEntityResponse(detail, instance string) ProblemDetails {
	return ProblemDetails{
