 ...
 */
export type createArtifactResponse201 = {
  data: CreateArtifact201
  status: 201
}

export type createArtifactResponseComposite = createArtifactResponse201

export type createArtifactResponse = createArtifactResponseComposite & {
  headers: Headers
}
...
export const createArtifact = async (
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text()
  const data: createArtifactResponse['data'] = body ? JSON.parse(body) : {}
 ...
 */
export type findManyArtifactsResponse200 = {
  data: FindManyArtifacts200
  status: 200
}

export type findManyArtifactsResponseComposite = findManyArtifactsResponse200

export type findManyArtifactsResponse = findManyArtifactsResponseComposite & {
  headers: Headers
}
...
export const findManyArtifacts = async (
  ...
  options?: RequestInit
): Promise<findManyArtifactsResponse> => {
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text()
  const data: findManyArtifactsResponse['data'] = body ? JSON.parse(body) : {}

  return {
    data,
    status: res.status,
    headers: res.headers
  } as findManyArtifactsResponse
}
...
export type deleteArtifactResponse200 = {
  data: DeleteArtifact200
  status: 200
}

export type deleteArtifactResponse404 = {
  data: DeleteArtifact404
  status: 404
}

export type deleteArtifactResponseComposite =
  | deleteArtifactResponse200
  | deleteArtifactResponse404

export type deleteArtifactResponse = deleteArtifactResponseComposite & {
  headers: Headers
}
...
export const deleteArtifact = async (
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text()
  const data: deleteArtifactResponse['data'] = body ? JSON.parse(body) : {}
 ...
 */
export type getOneArtifactResponse200 = {
  data: GetOneArtifact200
  status: 200
}

export type getOneArtifactResponse404 = {
  data: GetOneArtifact404
  status: 404
}

export type getOneArtifactResponseComposite =
  | getOneArtifactResponse200
  | getOneArtifactResponse404

export type getOneArtifactResponse = getOneArtifactResponseComposite & {
  headers: Headers
}
...
export const getOneArtifact = async (
  id: string,
  options?: RequestInit
): Promise<getOneArtifactResponse> => {
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text()
  const data: getOneArtifactResponse['data'] = body ? JSON.parse(body) : {}

  return {
    data,
    status: res.status,
    headers: res.headers
  } as getOneArtifactResponse
}
...
export type GetOneArtifactQueryResult = NonNullable<
  Awaited<ReturnType<typeof getOneArtifact>>
>
export type GetOneArtifactQueryError = GetOneArtifact404
 ...
 */
export type updateArtifactResponse200 = {
  data: UpdateArtifact200
  status: 200
}

export type updateArtifactResponse404 = {
  data: UpdateArtifact404
  status: 404
}

export type updateArtifactResponseComposite =
  | updateArtifactResponse200
  | updateArtifactResponse404

export type updateArtifactResponse = updateArtifactResponseComposite & {
  headers: Headers
}
...
export const updateArtifact = async (
  ...
  const body = [204, 205, 304].includes(res.status) ? null : await res.text()
  const data: updateArtifactResponse['data'] = body ? JSON.parse(body) : {}
...
export type GetSessionQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSession>>
>
export type GetSessionQueryError = GetSession401
