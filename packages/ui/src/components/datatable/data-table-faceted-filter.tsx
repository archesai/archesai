...
import { CheckSquare, PlusCircleIcon } from 'lucide-react'
        ...
        >
          ...
          {selectedValues.size > 0 && (
            <>
              ...
              />
              <Badge
                className='rounded-xs font-normal lg:hidden'
                variant='secondary'
              >
                {selectedValues.size}
              </Badge>
              ...
              {options.map((option) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={cn(
                        'border-primary flex h-5 w-5 items-center justify-center rounded-xs border',
                        isSelected
