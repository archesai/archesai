...
import (
	...
	postgresdb "github.com/archesai/examples/authentication/database/postgres"
	sqlitedb "github.com/archesai/examples/authentication/database/sqlite"
)

// openAPISpec contains the bundled OpenAPI specification.
var openAPISpec = []byte(`openapi: 3.1.0
x-project-name: github.com/archesai/examples/authentication
info:
  title: My API
  description: An authentication example API
  version: 1.0.0
tags:
  - name: Health
