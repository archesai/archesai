...
func (r *PostgresUserRepository) Create(ctx context.Context, entity *schemas.User) (*schemas.User, error) {
...
func (r *PostgresUserRepository) Get(ctx context.Context, id uuid.UUID) (*schemas.User, error) {
...
func (r *PostgresUserRepository) Update(ctx context.Context, id uuid.UUID, entity *schemas.User) (*schemas.User, error) {
...
func (r *PostgresUserRepository) List(ctx context.Context, limit, offset int32) ([]*schemas.User, int64, error) {
	...
	items := make([]*schemas.User, len(results))
...
func (r *PostgresUserRepository) GetUserBySessionID(ctx context.Context, sessionID string) (*schemas.User, error) {
...
func mapUserFromDB(db *User) *schemas.User {
	if db == nil {
		return nil
	}
