...
func (r *PostgresAccountRepository) Create(ctx context.Context, entity *schemas.Account) (*schemas.Account, error) {
...
func (r *PostgresAccountRepository) Get(ctx context.Context, id uuid.UUID) (*schemas.Account, error) {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return nil, schemas.ErrAccountNotFound
		}
...
func (r *PostgresAccountRepository) Update(ctx context.Context, id uuid.UUID, entity *schemas.Account) (*schemas.Account, error) {
...
func (r *PostgresAccountRepository) Delete(ctx context.Context, id uuid.UUID) error {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return schemas.ErrAccountNotFound
		}
...
func (r *PostgresAccountRepository) List(ctx context.Context, limit, offset int32) ([]*schemas.Account, int64, error) {
	...
	items := make([]*schemas.Account, len(results))
...
func (r *PostgresAccountRepository) GetAccountByProvider(ctx context.Context, provider string, accountIdentifier string) (*schemas.Account, error) {
...
func (r *PostgresAccountRepository) ListAccountsByUserID(ctx context.Context, userID string) ([]*schemas.Account, error) {
	...
	items := make([]*schemas.Account, len(result))
...
func mapAccountFromDB(db *Account) *schemas.Account {
	if db == nil {
		return nil
	}

	result := &schemas.Account{
		ID:                    db.ID,
		...
		IDToken:               db.IDToken,
		Provider:              schemas.AccountProvider(db.Provider),
