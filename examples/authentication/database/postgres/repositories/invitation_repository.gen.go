...
func (r *PostgresInvitationRepository) Create(ctx context.Context, entity *schemas.Invitation) (*schemas.Invitation, error) {
...
func (r *PostgresInvitationRepository) Get(ctx context.Context, id uuid.UUID) (*schemas.Invitation, error) {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return nil, schemas.ErrInvitationNotFound
		}
...
func (r *PostgresInvitationRepository) Update(ctx context.Context, id uuid.UUID, entity *schemas.Invitation) (*schemas.Invitation, error) {
...
func (r *PostgresInvitationRepository) Delete(ctx context.Context, id uuid.UUID) error {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return schemas.ErrInvitationNotFound
		}
...
func (r *PostgresInvitationRepository) List(ctx context.Context, limit, offset int32) ([]*schemas.Invitation, int64, error) {
	...
	items := make([]*schemas.Invitation, len(results))
...
func (r *PostgresInvitationRepository) ListInvitationsByOrganization(ctx context.Context, organizationID string) ([]*schemas.Invitation, error) {
	...
	items := make([]*schemas.Invitation, len(result))
...
func (r *PostgresInvitationRepository) GetInvitationByEmail(ctx context.Context, email string, organizationID string) (*schemas.Invitation, error) {
...
func (r *PostgresInvitationRepository) ListInvitationsByInviter(ctx context.Context, inviterID string) ([]*schemas.Invitation, error) {
...
func mapInvitationFromDB(db *Invitation) *schemas.Invitation {
	if db == nil {
		return nil
	}

	result := &schemas.Invitation{
		ID:             db.ID,
		...
		Role:           schemas.InvitationRole(db.Role),
		Status:         schemas.InvitationStatus(db.Status),
	}
