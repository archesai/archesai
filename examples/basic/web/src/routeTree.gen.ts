...
import { Route as AppTodosTodoIDIndexRouteImport } from './routes/_app/todos/$todoID/index'
...
const AppTodosTodoIDIndexRoute = AppTodosTodoIDIndexRouteImport.update({
  id: '/todos/$todoID/',
  path: '/todos/$todoID/',
  getParentRoute: () => AppRouteRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_app/todos/$todoID/': {
      ...
      preLoaderRoute: typeof AppTodosTodoIDIndexRouteImport
      parentRoute: typeof AppRouteRoute
    }
    '/_app/sessions/$sessionID/': {
