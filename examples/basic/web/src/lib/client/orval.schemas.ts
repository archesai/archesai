...
export type Todo = Base & TodoAllOf;
...
export type TodoListResponseResponse = {
  /** @maxItems 1000 */
  data: Todo[];
  meta: PaginationMeta;
};

export type TodoResponseResponse = {
  data: Todo;
};
 ...
 * The type of filter operation
 */
export type TodosFilterParameterType = typeof TodosFilterParameterType[keyof typeof TodosFilterParameterType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TodosFilterParameterType = {
  and: 'and',
  or: 'or',
  eq: 'eq',
  ne: 'ne',
 ...
 * The value to compare against (for leaf conditions)
 */
export type TodosFilterParameterValue = string | number | boolean;

/**
 * A recursive filter node that can be a condition or group
 */
export type TodosFilterParameter = {
  /** The type of filter operation */
  type: TodosFilterParameterType;
  /**
   * The field to filter on (for leaf conditions)
   * @minLength 1
   * @maxLength 255
  ...
  field?: string;
  /** The value to compare against (for leaf conditions) */
  value?: TodosFilterParameterValue;
};
 ...
 * @maxLength 255
 */
export type TodosSortParameterItemField = typeof TodosSortParameterItemField[keyof typeof TodosSortParameterItemField];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TodosSortParameterItemField = {
  id: 'id',
  createdAt: 'createdAt',
  updatedAt: 'updatedAt',
  title: 'title',
 ...
 * @maxLength 4
 */
export type TodosSortParameterItemOrder = typeof TodosSortParameterItemOrder[keyof typeof TodosSortParameterItemOrder];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const TodosSortParameterItemOrder = {
  asc: 'asc',
  desc: 'desc',
} as const;

export type TodosSortParameterItem = {
  /**
   * @minLength 1
   * @maxLength 255
   */
  field: TodosSortParameterItemField;
  /**
   * @minLength 1
   * @maxLength 4
   */
  order: TodosSortParameterItemOrder;
};

/**
 * Sort criteria for todos
 */
export type TodosSortParameter = TodosSortParameterItem[];
