...
export const listExecutorsResponseDataItemIsActiveDefault = true;export const listExecutorsResponseDataItemVersionDefault = 1;export const listExecutorsResponseDataMax = 10000;
...
export const listExecutorsResponse = zod.object({
  ...
  "executeCode": zod.string().max(listExecutorsResponseDataItemExecuteCodeMax).describe('The custom execute function code'),
  "dependencies": zod.string().max(listExecutorsResponseDataItemDependenciesMax).nullish().describe('Dependencies configuration (package.json for Node, requirements.txt for Python, go.mod for Go)'),
  "schemaIn": zod.string().max(listExecutorsResponseDataItemSchemaInMax).nullish().describe('JSON Schema for input validation'),
  "schemaOut": zod.string().max(listExecutorsResponseDataItemSchemaOutMax).nullish().describe('JSON Schema for output validation'),
  "extraFiles": zod.string().max(listExecutorsResponseDataItemExtraFilesMax).nullish().describe('Additional files to mount in the executor (stored as JSON array)'),
  ...
  "env": zod.string().max(listExecutorsResponseDataItemEnvMax).nullish().describe('Environment variables (stored as JSON array)'),
  "isActive": zod.boolean().describe('Whether the executor is active and can be used'),
  "version": zod.number().describe('Version number for cache busting')
...
export const createExecutorBody = zod.object({
  ...
  "language": zod.enum(['nodejs', 'python', 'go']).describe('The programming language for the executor'),
  "executeCode": zod.string().max(createExecutorBodyExecuteCodeMax).describe('The custom execute function code'),
  "dependencies": zod.string().max(createExecutorBodyDependenciesMax).optional().describe('Dependencies configuration'),
  "schemaIn": zod.string().max(createExecutorBodySchemaInMax).optional().describe('Input JSON Schema'),
  "schemaOut": zod.string().max(createExecutorBodySchemaOutMax).optional().describe('Output JSON Schema'),
  "extraFiles": zod.string().max(createExecutorBodyExtraFilesMax).optional().describe('Additional files to mount'),
  ...
  "env": zod.string().max(createExecutorBodyEnvMax).optional().describe('Environment variables as JSON array')
})
...
export const getExecutorResponse = zod.object({
  ...
  "language": zod.enum(['nodejs', 'python', 'go']).describe('The programming language for the executor'),
  "executeCode": zod.string().max(getExecutorResponseDataExecuteCodeMax).describe('The custom execute function code'),
  "dependencies": zod.string().max(getExecutorResponseDataDependenciesMax).nullish().describe('Dependencies configuration (package.json for Node, requirements.txt for Python, go.mod for Go)'),
  "schemaIn": zod.string().max(getExecutorResponseDataSchemaInMax).nullish().describe('JSON Schema for input validation'),
  "schemaOut": zod.string().max(getExecutorResponseDataSchemaOutMax).nullish().describe('JSON Schema for output validation'),
  "extraFiles": zod.string().max(getExecutorResponseDataExtraFilesMax).nullish().describe('Additional files to mount in the executor (stored as JSON array)'),
  ...
  "env": zod.string().max(getExecutorResponseDataEnvMax).nullish().describe('Environment variables (stored as JSON array)'),
  "isActive": zod.boolean().describe('Whether the executor is active and can be used'),
  "version": zod.number().describe('Version number for cache busting')
...
export const updateExecutorBody = zod.object({
  ...
  "executeCode": zod.string().max(updateExecutorBodyExecuteCodeMax).optional().describe('The custom execute function code'),
  "dependencies": zod.string().max(updateExecutorBodyDependenciesMax).optional().describe('Dependencies configuration'),
  "schemaIn": zod.string().max(updateExecutorBodySchemaInMax).optional().describe('Input JSON Schema'),
  "schemaOut": zod.string().max(updateExecutorBodySchemaOutMax).optional().describe('Output JSON Schema'),
  "extraFiles": zod.string().max(updateExecutorBodyExtraFilesMax).optional().describe('Additional files to mount'),
  ...
  "env": zod.string().max(updateExecutorBodyEnvMax).optional().describe('Environment variables as JSON array'),
...
export const updateExecutorResponse = zod.object({
  ...
  "language": zod.enum(['nodejs', 'python', 'go']).describe('The programming language for the executor'),
  "executeCode": zod.string().max(updateExecutorResponseDataExecuteCodeMax).describe('The custom execute function code'),
  "dependencies": zod.string().max(updateExecutorResponseDataDependenciesMax).nullish().describe('Dependencies configuration (package.json for Node, requirements.txt for Python, go.mod for Go)'),
  "schemaIn": zod.string().max(updateExecutorResponseDataSchemaInMax).nullish().describe('JSON Schema for input validation'),
  "schemaOut": zod.string().max(updateExecutorResponseDataSchemaOutMax).nullish().describe('JSON Schema for output validation'),
  "extraFiles": zod.string().max(updateExecutorResponseDataExtraFilesMax).nullish().describe('Additional files to mount in the executor (stored as JSON array)'),
  ...
  "env": zod.string().max(updateExecutorResponseDataEnvMax).nullish().describe('Environment variables (stored as JSON array)'),
  "isActive": zod.boolean().describe('Whether the executor is active and can be used'),
  "version": zod.number().describe('Version number for cache busting')
})).describe('Schema for Executor entity')
})
...
export const executeExecutorResponse = zod.object({
  ...
  "executionTimeMs": zod.number().optional().describe('Execution time in milliseconds'),
  "logs": zod.string().optional().describe('Execution logs from stderr')
}).optional()
})
