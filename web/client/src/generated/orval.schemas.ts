 ...
 */
export type ExecuteExecutor200DataOutput = { [key: string]: unknown };

export type ExecuteExecutor200Data = {
  /** Execution result (matches executor's output schema) */
  output: ExecuteExecutor200DataOutput;
  /**
...
export type ExecuteExecutor200 = {
  data?: ExecuteExecutor200Data;
};
