...
export function DataTableDateFilter<TData>({
  ...
  const label = useMemo(() => {
    if (multiple) {
      ...
      const dateText =
        hasSelectedDates ? formatDateRange(selectedDates) : 'Select date range'
    ...
    const dateText =
      hasSelectedDate ? formatDate(selectedDates[0]) : 'Select date'
      ...
      >
        {multiple ?
          <Calendar
            ...
            onSelect={onSelect}
            selected={
              getIsDateRange(selectedDates) ? selectedDates : (
