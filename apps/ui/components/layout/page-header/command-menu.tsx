  ...
  return (
    <div>
      ...
      >
        ...
        <kbd className='border-sidebar-accent bg-sidebar-accent pointer-events-none flex h-5 select-none items-center gap-1 rounded border p-2 font-mono text-[10px] font-medium'>
