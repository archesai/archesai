...
export const listMembers = async (
  ...
  params?: ListMembersParams,
  options?: RequestInit,
): Promise<MemberListResponseResponse> => {
  return customFetch<MemberListResponseResponse>(
    getListMembersUrl(organizationID, params),
    {
      ...options,
      method: "GET",
    },
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListMembersQueryKey(organizationID, params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof listMembers>>> = ({
    signal,
  }) => listMembers(organizationID, params, { signal, ...requestOptions });
...
export type ListMembersSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof listMembers>>
>;
export type ListMembersSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | UnprocessableEntityResponse
  | TooManyRequestsResponse
...
>(
  ...
  const queryOptions = getListMembersSuspenseQueryOptions(
    organizationID,
    params,
    options,
  );
...
export const createMember = async (
  ...
  options?: RequestInit,
): Promise<MemberResponseResponse> => {
  return customFetch<MemberResponseResponse>(
    getCreateMemberUrl(organizationID),
    {
      ...options,
...
export const getMember = async (
  ...
  return customFetch<MemberResponseResponse>(
    getGetMemberUrl(organizationID, id),
    {
      ...options,
      method: "GET",
    },
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetMemberQueryKey(organizationID, id);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getMember>>> = ({
    signal,
  }) => getMember(organizationID, id, { signal, ...requestOptions });
...
>;
export type GetMemberQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export type GetMemberSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getMember>>
>;
export type GetMemberSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
>(
  ...
  const queryOptions = getGetMemberSuspenseQueryOptions(
    organizationID,
    id,
    options,
  );
...
export const updateMember = async (
  ...
  return customFetch<MemberResponseResponse>(
    getUpdateMemberUrl(organizationID, id),
    {
      ...options,
...
export const deleteMember = async (
  ...
  return customFetch<NoContentResponse>(
    getDeleteMemberUrl(organizationID, id),
    {
      ...options,
      method: "DELETE",
    },
...
export type DeleteMemberMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
