...
export type DeleteCurrentUserMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | UnprocessableEntityResponse
  | TooManyRequestsResponse
...
export const listUsers = async (
  ...
  options?: RequestInit,
): Promise<UserListResponseResponse> => {
...
export type ListUsersSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof listUsers>>
>;
export type ListUsersSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | UnprocessableEntityResponse
  | TooManyRequestsResponse
...
export type GetUserSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getUser>>
>;
export type GetUserSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
