...
>;
export type GetLabelQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export type GetLabelSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getLabel>>
>;
export type GetLabelSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export type UpdateLabelMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export type DeleteLabelMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export const listLabels = async (
  ...
  options?: RequestInit,
): Promise<LabelListResponseResponse> => {
...
export type ListLabelsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listLabels>>
>;
export type ListLabelsQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | UnprocessableEntityResponse
  | TooManyRequestsResponse
