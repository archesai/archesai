...
export const logout = async (
  options?: RequestInit,
): Promise<LogoutResponseResponse> => {
...
export type RequestMagicLinkMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | UnprocessableEntityResponse
  | TooManyRequestsResponse
...
export type VerifyMagicLinkMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export const confirmEmailVerification = async (
  ...
  options?: RequestInit,
): Promise<EmailVerificationResponseResponse> => {
  return customFetch<EmailVerificationResponseResponse>(
...
export const linkAccount = async (
  linkAccountBody: LinkAccountBody,
  options?: RequestInit,
): Promise<LinkAccount200> => {
  return customFetch<LinkAccount200>(getLinkAccountUrl(), {
    ...options,
    body: JSON.stringify(linkAccountBody),
    headers: { "Content-Type": "application/json", ...options?.headers },
    method: "POST",
  });
};
...
export type LinkAccountMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | ConflictResponse
  | UnprocessableEntityResponse
...
export type OauthAuthorizeQueryResult = NonNullable<
  Awaited<ReturnType<typeof oauthAuthorize>>
>;
export type OauthAuthorizeQueryError =
  | void
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
...
export const oauthCallback = async (
  ...
  return customFetch<SessionCreatedResponse>(
    getOauthCallbackUrl(provider, params),
    {
      ...options,
      method: "GET",
    },
...
export const listAccounts = async (
  options?: RequestInit,
): Promise<AccountListResponseResponse> => {
...
export const getAccount = async (
  ...
  options?: RequestInit,
): Promise<AccountResponseResponse> => {
...
export type GetAccountSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getAccount>>
>;
export type GetAccountSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export const listSessions = async (
  ...
  options?: RequestInit,
): Promise<SessionListResponseResponse> => {
...
export type ListSessionsSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof listSessions>>
>;
export type ListSessionsSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | UnprocessableEntityResponse
  | TooManyRequestsResponse
...
export const getSession = async (
  id: string | undefined | null,
  options?: RequestInit,
): Promise<SessionResponseResponse> => {
...
export type GetSessionSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSession>>
>;
export type GetSessionSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export type UpdateSessionMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export type DeleteSessionMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
