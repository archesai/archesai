 ...
 */
export const getGetPipelineExecutionPlanUrl = (
...
export const getPipelineExecutionPlan = async (
  id: string | undefined | null,
  options?: RequestInit,
): Promise<PipelineExecutionPlanResponseResponse> => {
  return customFetch<PipelineExecutionPlanResponseResponse>(
...
export const validatePipelineExecutionPlan = async (
  id: string | undefined | null,
  options?: RequestInit,
): Promise<PipelineResponseResponse> => {
  return customFetch<PipelineResponseResponse>(
...
export const getPipelineSteps = async (
  id: string | undefined | null,
  options?: RequestInit,
): Promise<PipelineStepListResponseResponse> => {
  return customFetch<PipelineStepListResponseResponse>(
    getGetPipelineStepsUrl(id),
    {
      ...options,
      method: "GET",
    },
...
export const createPipelineStep = async (
  ...
  options?: RequestInit,
): Promise<PipelineStepResponseResponse> => {
  return customFetch<PipelineStepResponseResponse>(
    getCreatePipelineStepUrl(id),
    {
      ...options,
...
export type GetPipelineSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPipeline>>
>;
export type GetPipelineSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export const listPipelines = async (
  ...
  options?: RequestInit,
): Promise<PipelineListResponseResponse> => {
  return customFetch<PipelineListResponseResponse>(
    getListPipelinesUrl(params),
    {
      ...options,
      method: "GET",
    },
