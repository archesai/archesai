...
export const listOrganizations = async (
  ...
  options?: RequestInit,
): Promise<OrganizationListResponseResponse> => {
  return customFetch<OrganizationListResponseResponse>(
...
export const createOrganization = async (
  ...
  options?: RequestInit,
): Promise<OrganizationResponseResponse> => {
...
export type GetOrganizationQueryResult = NonNullable<
  Awaited<ReturnType<typeof getOrganization>>
>;
export type GetOrganizationQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export type GetOrganizationSuspenseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getOrganization>>
>;
export type GetOrganizationSuspenseQueryError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
...
export const updateOrganization = async (
  ...
  return customFetch<OrganizationResponseResponse>(
...
export type DeleteOrganizationMutationError =
  | BadRequestResponse
  | UnauthorizedResponse
  | NotFoundResponse
  | UnprocessableEntityResponse
