...
func (r *PostgresAPIKeyRepository) Create(ctx context.Context, entity *schemas.APIKey) (*schemas.APIKey, error) {
...
func (r *PostgresAPIKeyRepository) Get(ctx context.Context, id uuid.UUID) (*schemas.APIKey, error) {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return nil, schemas.ErrAPIKeyNotFound
		}
...
func (r *PostgresAPIKeyRepository) Update(ctx context.Context, id uuid.UUID, entity *schemas.APIKey) (*schemas.APIKey, error) {
...
func (r *PostgresAPIKeyRepository) Delete(ctx context.Context, id uuid.UUID) error {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return schemas.ErrAPIKeyNotFound
		}
...
func (r *PostgresAPIKeyRepository) List(ctx context.Context, limit, offset int32) ([]*schemas.APIKey, int64, error) {
	...
	items := make([]*schemas.APIKey, len(results))
...
func mapAPIKeyFromDB(db *APIKey) *schemas.APIKey {
	if db == nil {
		return nil
	}

	result := &schemas.APIKey{
		ID:             db.ID,
