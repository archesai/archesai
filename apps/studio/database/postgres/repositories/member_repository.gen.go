...
func (r *PostgresMemberRepository) Create(ctx context.Context, entity *schemas.Member) (*schemas.Member, error) {
...
func (r *PostgresMemberRepository) Get(ctx context.Context, id uuid.UUID) (*schemas.Member, error) {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return nil, schemas.ErrMemberNotFound
		}
...
func (r *PostgresMemberRepository) Update(ctx context.Context, id uuid.UUID, entity *schemas.Member) (*schemas.Member, error) {
...
func (r *PostgresMemberRepository) Delete(ctx context.Context, id uuid.UUID) error {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return schemas.ErrMemberNotFound
		}
...
func (r *PostgresMemberRepository) List(ctx context.Context, limit, offset int32) ([]*schemas.Member, int64, error) {
	...
	items := make([]*schemas.Member, len(results))
...
func (r *PostgresMemberRepository) ListMembersByOrganization(ctx context.Context, organizationID string) ([]*schemas.Member, error) {
	...
	items := make([]*schemas.Member, len(result))
...
func (r *PostgresMemberRepository) ListMembersByUser(ctx context.Context, userID string) ([]*schemas.Member, error) {
...
func (r *PostgresMemberRepository) GetMemberByUserAndOrganization(ctx context.Context, userID string, organizationID string) (*schemas.Member, error) {
...
func mapMemberFromDB(db *Member) *schemas.Member {
	if db == nil {
		return nil
	}

	result := &schemas.Member{
		ID:             db.ID,
		CreatedAt:      db.CreatedAt,
		UpdatedAt:      db.UpdatedAt,
		OrganizationID: db.OrganizationID,
		Role:           schemas.MemberRole(db.Role),
		UserID:         db.UserID,
	}
