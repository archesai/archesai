...
func (r *PostgresToolRepository) Create(ctx context.Context, entity *schemas.Tool) (*schemas.Tool, error) {
...
func (r *PostgresToolRepository) Get(ctx context.Context, id uuid.UUID) (*schemas.Tool, error) {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return nil, schemas.ErrToolNotFound
		}
...
func (r *PostgresToolRepository) Update(ctx context.Context, id uuid.UUID, entity *schemas.Tool) (*schemas.Tool, error) {
...
func (r *PostgresToolRepository) Delete(ctx context.Context, id uuid.UUID) error {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return schemas.ErrToolNotFound
		}
...
func (r *PostgresToolRepository) List(ctx context.Context, limit, offset int32) ([]*schemas.Tool, int64, error) {
	...
	items := make([]*schemas.Tool, len(results))
...
func (r *PostgresToolRepository) ListToolsByOrganization(ctx context.Context, organizationID string) ([]*schemas.Tool, error) {
	...
	items := make([]*schemas.Tool, len(result))
...
func mapToolFromDB(db *Tool) *schemas.Tool {
	if db == nil {
		return nil
	}
