...
func (r *PostgresExecutorRepository) Create(ctx context.Context, entity *schemas.Executor) (*schemas.Executor, error) {
...
func (r *PostgresExecutorRepository) Get(ctx context.Context, id uuid.UUID) (*schemas.Executor, error) {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return nil, schemas.ErrExecutorNotFound
		}
...
func (r *PostgresExecutorRepository) Update(ctx context.Context, id uuid.UUID, entity *schemas.Executor) (*schemas.Executor, error) {
...
func (r *PostgresExecutorRepository) Delete(ctx context.Context, id uuid.UUID) error {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return schemas.ErrExecutorNotFound
		}
...
func (r *PostgresExecutorRepository) List(ctx context.Context, limit, offset int32) ([]*schemas.Executor, int64, error) {
	...
	items := make([]*schemas.Executor, len(results))
...
func (r *PostgresExecutorRepository) ListExecutorsByOrganization(ctx context.Context, organizationID string) ([]*schemas.Executor, error) {
	...
	items := make([]*schemas.Executor, len(result))
...
func mapExecutorFromDB(db *Executor) *schemas.Executor {
	if db == nil {
		return nil
	}

	result := &schemas.Executor{
		ID:             db.ID,
		...
		Language:       schemas.ExecutorLanguage(db.Language),
