...
func (r *PostgresPipelineStepRepository) Create(ctx context.Context, entity *schemas.PipelineStep) (*schemas.PipelineStep, error) {
...
func (r *PostgresPipelineStepRepository) Get(ctx context.Context, id uuid.UUID) (*schemas.PipelineStep, error) {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return nil, schemas.ErrPipelineStepNotFound
		}
...
func (r *PostgresPipelineStepRepository) Update(ctx context.Context, id uuid.UUID, entity *schemas.PipelineStep) (*schemas.PipelineStep, error) {
...
func (r *PostgresPipelineStepRepository) Delete(ctx context.Context, id uuid.UUID) error {
	...
	if err != nil {
		if errors.Is(err, pgx.ErrNoRows) || err == sql.ErrNoRows {
			return schemas.ErrPipelineStepNotFound
		}
...
func (r *PostgresPipelineStepRepository) List(ctx context.Context, limit, offset int32) ([]*schemas.PipelineStep, int64, error) {
	...
	items := make([]*schemas.PipelineStep, len(results))
...
func mapPipelineStepFromDB(db *PipelineStep) *schemas.PipelineStep {
	if db == nil {
		return nil
	}

	result := &schemas.PipelineStep{
		ID:         db.ID,
