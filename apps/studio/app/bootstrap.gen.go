...
import (
	...
	postgresdb "github.com/archesai/archesai/apps/studio/database/postgres"
	sqlitedb "github.com/archesai/archesai/apps/studio/database/sqlite"
)

// openAPISpec contains the bundled OpenAPI specification.
var openAPISpec = []byte(`openapi: 3.1.0
x-project-name: github.com/archesai/archesai/apps/studio
info:
  title: Arches Platform API
  description: The Arches Platform API for managing projects and code generation
  version: v0.0.0
tags:
  - name: Health
...
paths:
  ...
  /executors:
    get:
      ...
      tags:
        - Executor
      parameters:
        - $ref: '#/components/parameters/ExecutorsFilter'
        - $ref: '#/components/parameters/PageQuery'
        - $ref: '#/components/parameters/ExecutorsSort'
      responses:
        '200':
          $ref: '#/components/responses/ExecutorListResponse'
        '400':
          $ref: '#/components/responses/BadRequest'
        '401':
          $ref: '#/components/responses/Unauthorized'
    ...
    post:
      ...
      responses:
        '201':
          $ref: '#/components/responses/ExecutorResponse'
        '400':
          $ref: '#/components/responses/BadRequest'
        '401':
          $ref: '#/components/responses/Unauthorized'
  ...
  /executors/{id}:
    get:
      ...
      description: Find an executor by ID
      security:
        - bearerAuth: []
      tags:
        - Executor
    ...
    delete:
      ...
      description: Delete an executor
      security:
        - bearerAuth: []
      tags:
        - Executor
    ...
    patch:
      ...
      description: Update an executor
      security:
        - bearerAuth: []
      tags:
        - Executor
      parameters:
        - $ref: '#/components/parameters/ResourceID'
      requestBody:
        description: Executor update data
        content:
          application/json:
            schema:
              type: object
  ...
  /executors/{id}/execute:
    post:
      ...
      description: Run the executor with provided input
      security:
        - bearerAuth: []
      tags:
        - Executor
      parameters:
        - $ref: '#/components/parameters/ResourceID'
      requestBody:
        description: Execution request with input data
        required: true
        content:
          application/json:
            schema:
              ...
              properties:
                input:
                  description: Input data for the executor (must match executor's input schema)
                  type: object
                  example:
                    value: 42
              required:
      ...
      responses:
        '200':
          $ref: '#/components/responses/SuccessfulExecutionResponse'
        '400':
          $ref: '#/components/responses/BadRequest'
        '401':
          $ref: '#/components/responses/Unauthorized'
...
components:
  schemas:
    ...
    ConfigGeneration:
      ...
      properties:
        includes:
          description: Built-in package includes (server, auth, config, pipelines, executor, storage)
          type: array
          items:
            type: string
            minLength: 1
        ...
        lint:
          ...
          type: boolean
        only:
          description: Generators to run (empty = all)
          type: array
          items:
            type: string
            minLength: 1
    ...
    PipelineExecutionPlan:
      ...
      properties:
        ...
        levels:
          type: array
          items:
            $ref: '#/components/schemas/PipelineExecutionPlanLevelsItem'
          maxItems: 1000
        pipelineID:
          description: UUID identifier
          type: string
      ...
      required:
        ...
        - totalSteps
        - isValid
    PipelineExecutionPlanLevelsItem:
      type: object
      properties:
        level:
    ...
    SuccessfulExecution:
      ...
      properties:
        executionTimeMs:
          ...
          example: 1234
        logs:
          description: Execution logs from stderr
          type: string
          maxLength: 1000000
          pattern: ^[\s\S]*$
          example: "Container started\nExecution completed"
        output:
          description: Execution result (matches executor's output schema)
          type: object
          example:
            doubled: 84
      required:
  ...
  responses:
    ...
    ExecutorListResponse:
      description: Executors retrieved successfully
      headers:
        X-RateLimit-Limit:
          $ref: '#/components/headers/RateLimitLimit'
        X-RateLimit-Remaining:
        ...
        application/json:
          schema:
            ...
            required:
              ...
              - meta
    ExecutorResponse:
      description: Executor retrieved successfully
      headers:
        X-RateLimit-Limit:
          $ref: '#/components/headers/RateLimitLimit'
        X-RateLimit-Remaining:
      ...
      content:
        application/json:
          schema:
            ...
            properties:
              data:
                $ref: '#/components/schemas/PipelineExecutionPlan'
            additionalProperties: false
            required:
              - data
...
func (a *App) Initialize() error {
	...
	if cfg.Config.Database.RunMigrations {
		...
		case configmodels.ConfigDatabaseTypePostgresql:
			runner = database.NewMigrationRunner(db, postgresdb.Migrations)
		case configmodels.ConfigDatabaseTypeSqlite:
	...
	// Create infrastructure, handlers, and routes
	infra := NewInfrastructure(db)
	handlers := NewHandlers(infra)
	a.routes = NewRoutes(handlers)
	...
	// Register routes
	RegisterRoutes(a.apiServer.Mux(), a.routes)

	// Register API documentation routes
	server.RegisterScalarRoutes(a.apiServer.Mux(), openAPISpec, "Arches Platform API")
