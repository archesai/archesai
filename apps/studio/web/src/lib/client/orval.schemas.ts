 ...
 */
export type ExecutorAllOfLanguage = typeof ExecutorAllOfLanguage[keyof typeof ExecutorAllOfLanguage];
...
export interface PipelineExecutionPlanLevelsItem {
  /**
 ...
 */
export type SuccessfulExecutionOutput = { [key: string]: unknown };
...
export interface SuccessfulExecution {
  ...
  logs?: string;
  /** Execution result (matches executor's output schema) */
  output: SuccessfulExecutionOutput;
}
 ...
 * The type of filter operation
 */
export type ExecutorsFilterParameterType = typeof ExecutorsFilterParameterType[keyof typeof ExecutorsFilterParameterType];
...
export type ExecutorsSortParameterItemField = typeof ExecutorsSortParameterItemField[keyof typeof ExecutorsSortParameterItemField];
...
export type ExecutorsSortParameterItemOrder = typeof ExecutorsSortParameterItemOrder[keyof typeof ExecutorsSortParameterItemOrder];
 ...
 * The programming language for the executor
 */
export type CreateExecutorBodyLanguage = typeof CreateExecutorBodyLanguage[keyof typeof CreateExecutorBodyLanguage];
 ...
 * The programming language for the executor
 */
export type UpdateExecutorBodyLanguage = typeof UpdateExecutorBodyLanguage[keyof typeof UpdateExecutorBodyLanguage];
