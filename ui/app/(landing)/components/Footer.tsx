    ...
    <footer id='footer'>
      ...
      <section className='container grid grid-cols-2 gap-x-12 gap-y-8 py-20 md:grid-cols-4 xl:grid-cols-6'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <div>
            <a className='opacity-60 hover:opacity-100' href='https://github.com/archesai' rel='noreferrer noopener'>
              Github
            </a>
          </div>

          <div>
            <a className='opacity-60 hover:opacity-100' href='https://x.com/archesai' rel='noreferrer noopener'>
              Twitter
            </a>
          </div>
        </div>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <div>
            <a className='opacity-60 hover:opacity-100' href='#' rel='noreferrer noopener'>
              Web
            </a>
          </div>
