...
export default function ForgotPasswordPage() {
  const { mutateAsync: requestPasswordReset } = useAuthControllerPasswordResetRequest()
  ...
  return (
    <div className='flex flex-col gap-2'>
      <div className='flex flex-col gap-2 text-center'>
        ...
        <p className='text-md text-muted-foreground'>Enter your email address to receive a password reset link.</p>
      </div>
      <div className='flex flex-col gap-2'>
