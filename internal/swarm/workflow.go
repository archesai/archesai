...
const (
	// CollaborativeWorkflow represents a collaborative workflow type
	CollaborativeWorkflow WorkflowType = iota
	// SupervisorWorkflow represents a supervisor-based workflow
	SupervisorWorkflow
	// HierarchicalWorkflow represents a hierarchical workflow
...
const (
	// ResearchTeam represents a research-focused team
	ResearchTeam TeamType = "research"
	// DocumentTeam represents a documentation team
	DocumentTeam TeamType = "document"
	// SupervisorTeam represents a supervisor team
	SupervisorTeam TeamType = "supervisor"
	// AnalysisTeam represents an analysis team
	AnalysisTeam TeamType = "analysis"
	// DeveloperTeam represents a development team
...
const (
	// StopOnCycle stops execution when a cycle is detected
	StopOnCycle CycleHandling = iota
	// ContinueOnCycle continues execution despite cycles
	ContinueOnCycle
)
...
func NewWorkflow(apikey string, provider llm.Provider, workflowType WorkflowType) *Workflow {
