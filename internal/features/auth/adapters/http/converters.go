...
func convertToGeneratedUser(u *domain.User) users.UserEntity {
...
func convertToGeneratedUsers(domainUsers []*domain.User) []users.UserEntity {
...
func convertFilter(filter *users.UsersFilterNode) map[string]interface{} {
	if filter == nil {
		return nil
	}
