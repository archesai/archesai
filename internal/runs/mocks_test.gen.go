...
func (_mock *MockRepository) ListByOrganization(ctx context.Context, organizationID uuid.UUID) ([]*Run, error) {
...
func (_c *MockRepository_ListByOrganization_Call) RunAndReturn(run func(ctx context.Context, organizationID uuid.UUID) ([]*Run, error)) *MockRepository_ListByOrganization_Call {
	_c.Call.Return(run)
	return _c
}

// ListByPipeline provides a mock function for the type MockRepository
func (_mock *MockRepository) ListByPipeline(ctx context.Context, pipelineID uuid.UUID) ([]*Run, error) {
...
func (_c *MockRepository_ListByPipeline_Call) Run(run func(ctx context.Context, pipelineID uuid.UUID)) *MockRepository_ListByPipeline_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_ListByPipeline_Call) RunAndReturn(run func(ctx context.Context, pipelineID uuid.UUID) ([]*Run, error)) *MockRepository_ListByPipeline_Call {
	_c.Call.Return(run)
	return _c
}

// ListByTool provides a mock function for the type MockRepository
func (_mock *MockRepository) ListByTool(ctx context.Context, toolID uuid.UUID) ([]*Run, error) {
...
func (_c *MockRepository_ListByTool_Call) Run(run func(ctx context.Context, toolID uuid.UUID)) *MockRepository_ListByTool_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_ListByTool_Call) RunAndReturn(run func(ctx context.Context, toolID uuid.UUID) ([]*Run, error)) *MockRepository_ListByTool_Call {
	_c.Call.Return(run)
	return _c
}
