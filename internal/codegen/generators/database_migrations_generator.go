...
// DatabaseMigrationsGenerator handles database migration generation using Atlas.
type DatabaseMigrationsGenerator struct {
...
func (m *DatabaseMigrationsGenerator) Start(ctx context.Context, dbType database.Type) error {
	switch dbType {
...
func (m *DatabaseMigrationsGenerator) Stop(ctx context.Context) error {
...
func (m *DatabaseMigrationsGenerator) GenerateMigration(ctx context.Context) error {
	if m.database == nil {
...
func (m *DatabaseMigrationsGenerator) loadHCLSchema() (*schema.Schema, error) {
...
func (m *DatabaseMigrationsGenerator) getNextMigrationVersion(migrationDir string) int {
...
func (m *DatabaseMigrationsGenerator) formatMigrationSQL(plan *migrate.Plan) string {
