...
type Repository interface {
	...
	GetArtifact(ctx context.Context, id openapi_types.UUID) (*Artifact, error)
	UpdateArtifact(ctx context.Context, artifact *Artifact) (*Artifact, error)
	DeleteArtifact(ctx context.Context, id openapi_types.UUID) error
	...
	GetLabel(ctx context.Context, id openapi_types.UUID) (*Label, error)
	GetLabelByName(ctx context.Context, orgID, name string) (*Label, error)
	UpdateLabel(ctx context.Context, label *Label) (*Label, error)
	DeleteLabel(ctx context.Context, id openapi_types.UUID) error
	ListLabels(ctx context.Context, orgID string, limit, offset int) ([]*Label, int, error)

	// Artifact-Label relationships
	AddLabelToArtifact(ctx context.Context, artifactID, labelID openapi_types.UUID) error
	RemoveLabelFromArtifact(ctx context.Context, artifactID, labelID openapi_types.UUID) error
	GetArtifactsByLabel(ctx context.Context, labelID openapi_types.UUID, limit, offset int) ([]*Artifact, int, error)
	GetLabelsByArtifact(ctx context.Context, artifactID openapi_types.UUID) ([]*Label, error)
}
...
func (s *Service) CreateArtifact(ctx context.Context, req *CreateArtifactRequest, orgID, producerID string) (*Artifact, error) {
	...
	artifact := &Artifact{
		ArtifactEntity: api.ArtifactEntity{
			Id:             openapi_types.UUID{}, // Will be set by repository
			Name:           name,
			Text:           req.Text,
...
func (s *Service) GetArtifact(ctx context.Context, id openapi_types.UUID) (*Artifact, error) {
...
func (s *Service) UpdateArtifact(ctx context.Context, id openapi_types.UUID, req *UpdateArtifactRequest) (*Artifact, error) {
	artifact, err := s.repo.GetArtifact(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get artifact: %w", err)
	}
...
func (s *Service) DeleteArtifact(ctx context.Context, id openapi_types.UUID) error {
...
func (s *Service) GetLabel(ctx context.Context, id openapi_types.UUID) (*Label, error) {
...
func (s *Service) UpdateLabel(ctx context.Context, id openapi_types.UUID, req *UpdateLabelRequest) (*Label, error) {
	label, err := s.repo.GetLabel(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get label: %w", err)
	}
...
func (s *Service) DeleteLabel(ctx context.Context, id openapi_types.UUID) error {
...
func (s *Service) GetArtifactsByLabel(ctx context.Context, labelID openapi_types.UUID, limit, offset int) ([]*Artifact, int, error) {
...
func (s *Service) GetLabelsByArtifact(ctx context.Context, artifactID openapi_types.UUID) ([]*Label, error) {
...
func (s *Service) AddLabelToArtifact(ctx context.Context, artifactID, labelID openapi_types.UUID) error {
...
func (s *Service) RemoveLabelFromArtifact(ctx context.Context, artifactID, labelID openapi_types.UUID) error {
