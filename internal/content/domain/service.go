...
// ContentService provides content business logic
...
func NewContentService(repo ContentRepository, logger *slog.Logger) *ContentService {
...
func (s *ContentService) CreateArtifact(ctx context.Context, req *CreateArtifactRequest, orgID, producerID string) (*Artifact, error) {
...
func (s *ContentService) GetArtifact(ctx context.Context, id uuid.UUID) (*Artifact, error) {
...
func (s *ContentService) UpdateArtifact(ctx context.Context, id uuid.UUID, req *UpdateArtifactRequest) (*Artifact, error) {
	artifact, err := s.repo.GetArtifact(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get artifact: %w", err)
	}
...
func (s *ContentService) DeleteArtifact(ctx context.Context, id uuid.UUID) error {
...
func (s *ContentService) ListArtifacts(ctx context.Context, orgID string, limit, offset int) ([]*Artifact, int, error) {
...
func (s *ContentService) SearchArtifacts(ctx context.Context, orgID, query string, limit, offset int) ([]*Artifact, int, error) {
...
func (s *ContentService) CreateLabel(ctx context.Context, req *CreateLabelRequest, orgID string) (*Label, error) {
...
func (s *ContentService) GetLabel(ctx context.Context, id uuid.UUID) (*Label, error) {
...
func (s *ContentService) UpdateLabel(ctx context.Context, id uuid.UUID, req *UpdateLabelRequest) (*Label, error) {
	label, err := s.repo.GetLabel(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get label: %w", err)
	}
...
func (s *ContentService) DeleteLabel(ctx context.Context, id uuid.UUID) error {
...
func (s *ContentService) ListLabels(ctx context.Context, orgID string, limit, offset int) ([]*Label, int, error) {
...
func (s *ContentService) GetArtifactsByLabel(ctx context.Context, labelID uuid.UUID, limit, offset int) ([]*Artifact, int, error) {
...
func (s *ContentService) GetLabelsByArtifact(ctx context.Context, artifactID uuid.UUID) ([]*Label, error) {
...
func (s *ContentService) AddLabelToArtifact(ctx context.Context, artifactID, labelID uuid.UUID) error {
...
func (s *ContentService) RemoveLabelFromArtifact(ctx context.Context, artifactID, labelID uuid.UUID) error {
