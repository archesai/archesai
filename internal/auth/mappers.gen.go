...
// AuthUserDBToAPI converts postgresql.User to UserEntity
func AuthUserDBToAPI(from *postgresql.User) UserEntity {
	return UserEntity{
...
// AuthSessionDBToAPI converts postgresql.Session to SessionEntity
func AuthSessionDBToAPI(from *postgresql.Session) SessionEntity {
...
// AuthAccountDBToAPI converts postgresql.Account to AccountEntity
func AuthAccountDBToAPI(from *postgresql.Account) AccountEntity {
	return AccountEntity{
		...
		ProviderId:            AccountEntityProviderId(from.ProviderId),
