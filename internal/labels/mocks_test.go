...
func (_mock *MockRepository) GetByName(ctx context.Context, name string, organizationId string) (*Label, error) {
	...
	var r0 *Label
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) (*Label, error)); ok {
		return returnFunc(ctx, name, organizationId)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, string) *Label); ok {
...
func (_c *MockRepository_GetByName_Call) Run(run func(ctx context.Context, name string, organizationId string)) *MockRepository_GetByName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_GetByName_Call) RunAndReturn(run func(ctx context.Context, name string, organizationId string) (*Label, error)) *MockRepository_GetByName_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) ListByOrganization(ctx context.Context, organizationId string) ([]*Label, error) {
	...
	var r0 []*Label
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) ([]*Label, error)); ok {
		return returnFunc(ctx, organizationId)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) []*Label); ok {
...
func (_c *MockRepository_ListByOrganization_Call) RunAndReturn(run func(ctx context.Context, organizationId string) ([]*Label, error)) *MockRepository_ListByOrganization_Call {
	_c.Call.Return(run)
	return _c
}
