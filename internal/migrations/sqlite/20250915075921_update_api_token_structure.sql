...
ALTER TABLE api_token ADD COLUMN last_used_at TEXT;
...
ALTER TABLE api_token ADD COLUMN user_id TEXT;
ALTER TABLE api_token ADD COLUMN enabled INTEGER NOT NULL DEFAULT 1;
ALTER TABLE api_token ADD COLUMN permissions TEXT;
ALTER TABLE api_token ADD COLUMN rate_limit_enabled INTEGER NOT NULL DEFAULT 0;
...
ALTER TABLE api_token ADD COLUMN last_refill TEXT;
ALTER TABLE api_token ADD COLUMN last_request TEXT;
