...
DROP CONSTRAINT IF EXISTS api_token_user_id_fkey;
...
ALTER TABLE api_token
ADD CONSTRAINT api_token_user_id_fkey FOREIGN KEY (user_id) REFERENCES "user" (id) ON DELETE CASCADE;

ALTER TABLE api_token
ADD CONSTRAINT api_token_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES organization (id) ON DELETE CASCADE;
...
ALTER TABLE api_token
DROP COLUMN IF EXISTS refill_amount;

ALTER TABLE api_token
DROP COLUMN IF EXISTS refill_interval;
...
ALTER TABLE api_token
DROP COLUMN IF EXISTS last_refill;
...
ALTER TABLE api_token
DROP CONSTRAINT IF EXISTS api_token_organization_id_fkey;
...
ALTER TABLE api_token
ADD COLUMN rate_limit_time_window INTEGER;
...
ALTER TABLE api_token
ADD COLUMN last_refill TIMESTAMPTZ;

ALTER TABLE api_token
ADD COLUMN last_request TIMESTAMPTZ;
...
ALTER TABLE api_token
ADD CONSTRAINT api_token_user_id_fkey FOREIGN KEY (user_id) REFERENCES organization (id) ON DELETE CASCADE ON UPDATE CASCADE;
