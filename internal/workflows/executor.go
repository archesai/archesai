...
type ToolRunner interface {
	...
	Run(ctx context.Context, tool *Tool, config map[string]interface{}, input interface{}) (interface{}, error)
}

// ToolRunnerFunc is an adapter to allow functions to be used as ToolRunner
type ToolRunnerFunc func(ctx context.Context, tool *Tool, config map[string]interface{}, input interface{}) (interface{}, error)

// Run implements ToolRunner
func (f ToolRunnerFunc) Run(ctx context.Context, tool *Tool, config map[string]interface{}, input interface{}) (interface{}, error) {
...
func NewWorkflowExecutor(repo Repository, pipelineManager *PipelineManager, runner ToolRunner, queue QueueService, logger *slog.Logger, maxParallel int) *WorkflowExecutor {
	if maxParallel <= 0 {
...
func (we *WorkflowExecutor) ExecutePipeline(ctx context.Context, pipelineID uuid.UUID, input map[string]interface{}) (*Run, error) {
	// Get pipeline
	pipeline, err := we.repo.GetPipeline(ctx, pipelineID)
	if err != nil {
	...
	createdRun, err := we.repo.CreateRun(ctx, run)
	if err != nil {
...
func (we *WorkflowExecutor) executeRun(ctx context.Context, runID uuid.UUID) {
	...
	// Get run details
	run, err := we.repo.GetRun(ctx, runID)
	if err != nil {
	...
	_, err = we.repo.UpdateRun(ctx, run.Id, run)
	if err != nil {
...
func (we *WorkflowExecutor) handleRunFailure(ctx context.Context, run *Run, err error) {
	...
	_, updateErr := we.repo.UpdateRun(ctx, run.Id, run)
	if updateErr != nil {
...
func (we *WorkflowExecutor) handleRunSuccess(ctx context.Context, run *Run) {
...
func (dte *dagToolExecutor) Execute(ctx context.Context, tool *Tool, input interface{}) (interface{}, error) {
...
func (ctr *ContainerToolRunner) Run(_ context.Context, tool *Tool, config map[string]interface{}, input interface{}) (interface{}, error) {
...
func (htr *HTTPToolRunner) Run(_ context.Context, tool *Tool, config map[string]interface{}, input interface{}) (interface{}, error) {
	_ = input // will be used in actual implementation
...
func (ctr *CompositeToolRunner) Run(ctx context.Context, tool *Tool, config map[string]interface{}, input interface{}) (interface{}, error) {
