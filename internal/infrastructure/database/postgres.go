...
func (db *PostgreSQL) Query(ctx context.Context, query string, args ...interface{}) (Rows, error) {
...
func (db *PostgreSQL) QueryRow(ctx context.Context, query string, args ...interface{}) Row {
	return &pgRow{row: db.pool.QueryRow(ctx, query, args...)}
}

// Exec executes a query without returning any rows
func (db *PostgreSQL) Exec(ctx context.Context, query string, args ...interface{}) (Result, error) {
...
func (db *PostgreSQL) Begin(ctx context.Context) (Transaction, error) {
...
func (db *PostgreSQL) BeginTx(ctx context.Context, opts *sql.TxOptions) (Transaction, error) {
...
func (db *PostgreSQL) Stats() Stats {
	stats := db.pool.Stat()
	return Stats{
