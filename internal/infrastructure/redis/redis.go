// Package redis provides a Redis client service for health monitoring and connection management
package redis
...
// Service defines the interface for Redis service operations
...
// New creates a new Redis service instance
func New() Service {
