...
func (_mock *MockRepository) ListByOrganization(ctx context.Context, organizationId string) ([]*Artifact, error) {
...
func (_c *MockRepository_ListByOrganization_Call) RunAndReturn(run func(ctx context.Context, organizationId string) ([]*Artifact, error)) *MockRepository_ListByOrganization_Call {
	_c.Call.Return(run)
	return _c
}
