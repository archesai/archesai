...
func (_mock *MockRepository) ListByOrganization(ctx context.Context, organizationID uuid.UUID) ([]*Pipeline, error) {
...
func (_c *MockRepository_ListByOrganization_Call) RunAndReturn(run func(ctx context.Context, organizationID uuid.UUID) ([]*Pipeline, error)) *MockRepository_ListByOrganization_Call {
	_c.Call.Return(run)
	return _c
}
