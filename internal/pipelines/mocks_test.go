...
func (_mock *MockRepository) Create(ctx context.Context, entity *Pipeline) (*Pipeline, error) {
...
func (_c *MockRepository_Create_Call) Run(run func(ctx context.Context, entity *Pipeline)) *MockRepository_Create_Call {
...
func (_c *MockRepository_Create_Call) Return(pipeline *Pipeline, err error) *MockRepository_Create_Call {
	_c.Call.Return(pipeline, err)
	return _c
}

func (_c *MockRepository_Create_Call) RunAndReturn(run func(ctx context.Context, entity *Pipeline) (*Pipeline, error)) *MockRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) Get(ctx context.Context, id uuid.UUID) (*Pipeline, error) {
	ret := _mock.Called(ctx, id)
...
func (_c *MockRepository_Get_Call) Return(pipeline *Pipeline, err error) *MockRepository_Get_Call {
	_c.Call.Return(pipeline, err)
	return _c
}

func (_c *MockRepository_Get_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (*Pipeline, error)) *MockRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function for the type MockRepository
func (_mock *MockRepository) List(ctx context.Context, params ListPipelinesParams) ([]*Pipeline, int64, error) {
...
func (_c *MockRepository_List_Call) Run(run func(ctx context.Context, params ListPipelinesParams)) *MockRepository_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_List_Call) Return(pipelines []*Pipeline, n int64, err error) *MockRepository_List_Call {
	_c.Call.Return(pipelines, n, err)
	return _c
}

func (_c *MockRepository_List_Call) RunAndReturn(run func(ctx context.Context, params ListPipelinesParams) ([]*Pipeline, int64, error)) *MockRepository_List_Call {
	_c.Call.Return(run)
	return _c
}

// ListByOrganization provides a mock function for the type MockRepository
func (_mock *MockRepository) ListByOrganization(ctx context.Context, organizationId string) ([]*Pipeline, error) {
	...
	var r0 []*Pipeline
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) ([]*Pipeline, error)); ok {
		return returnFunc(ctx, organizationId)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) []*Pipeline); ok {
...
func (_c *MockRepository_ListByOrganization_Call) Return(pipelines []*Pipeline, err error) *MockRepository_ListByOrganization_Call {
	_c.Call.Return(pipelines, err)
	return _c
}

func (_c *MockRepository_ListByOrganization_Call) RunAndReturn(run func(ctx context.Context, organizationId string) ([]*Pipeline, error)) *MockRepository_ListByOrganization_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function for the type MockRepository
func (_mock *MockRepository) Update(ctx context.Context, id uuid.UUID, entity *Pipeline) (*Pipeline, error) {
...
func (_c *MockRepository_Update_Call) Run(run func(ctx context.Context, id uuid.UUID, entity *Pipeline)) *MockRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_Update_Call) Return(pipeline *Pipeline, err error) *MockRepository_Update_Call {
	_c.Call.Return(pipeline, err)
	return _c
}

func (_c *MockRepository_Update_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID, entity *Pipeline) (*Pipeline, error)) *MockRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
