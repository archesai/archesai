...
func (_mock *MockRepository) GetByEmail(ctx context.Context, email string, organizationID uuid.UUID) (*Invitation, error) {
	...
	var r0 *Invitation
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, uuid.UUID) (*Invitation, error)); ok {
		return returnFunc(ctx, email, organizationID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, uuid.UUID) *Invitation); ok {
...
func (_c *MockRepository_GetByEmail_Call) Run(run func(ctx context.Context, email string, organizationID uuid.UUID)) *MockRepository_GetByEmail_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_GetByEmail_Call) RunAndReturn(run func(ctx context.Context, email string, organizationID uuid.UUID) (*Invitation, error)) *MockRepository_GetByEmail_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) ListByOrganization(ctx context.Context, organizationID uuid.UUID) ([]*Invitation, error) {
...
func (_c *MockRepository_ListByOrganization_Call) RunAndReturn(run func(ctx context.Context, organizationID uuid.UUID) ([]*Invitation, error)) *MockRepository_ListByOrganization_Call {
	_c.Call.Return(run)
	return _c
}
