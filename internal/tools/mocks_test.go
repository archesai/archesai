...
func (_mock *MockRepository) ListByOrganization(ctx context.Context, organizationId string) ([]*Tool, error) {
	...
	var r0 []*Tool
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) ([]*Tool, error)); ok {
		return returnFunc(ctx, organizationId)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) []*Tool); ok {
...
func (_c *MockRepository_ListByOrganization_Call) RunAndReturn(run func(ctx context.Context, organizationId string) ([]*Tool, error)) *MockRepository_ListByOrganization_Call {
	_c.Call.Return(run)
	return _c
}
