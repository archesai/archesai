...
func (r *OrganizationSQLiteRepository) GetOrganization(_ context.Context, _ uuid.UUID) (*Organization, error) {
	return nil, fmt.Errorf("SQLite implementation not yet available")
}

// UpdateOrganization updates an organization
func (r *OrganizationSQLiteRepository) UpdateOrganization(_ context.Context, _ *Organization) (*Organization, error) {
	return nil, fmt.Errorf("SQLite implementation not yet available")
}
...
func (r *OrganizationSQLiteRepository) ListOrganizations(_ context.Context, _, _ int) ([]*Organization, int, error) {
