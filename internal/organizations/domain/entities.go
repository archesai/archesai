// Package domain contains the organizations domain business logic and entities
package domain
...
// Domain constants
const (
	DefaultPlan = "free" // Default plan for new organizations
)
...
type CreateOrganizationRequest struct {
	...
	Plan         OrganizationEntityPlan `json:"plan,omitempty"`
}
...
func (m *Member) HasPermission(requiredRole MemberEntityRole) bool {
...
func getRoleWeight(role MemberEntityRole) int {
	switch role {
	case MemberEntityRoleOwner:
		return 3
	case MemberEntityRoleAdmin:
		return 2
	case MemberEntityRoleMember:
		return 1
	default:
		return 0
	}
